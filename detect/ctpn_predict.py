...
class PytorchDetect():
    def __init__(self, model_path='checkpoints/CTPN.pth', prob_thresh=0.5):
...
if __name__ == '__main__':
    img_path = 'F:\\Git\\Image Processing Midterm Test2\\test_images\\img4.jpeg'
    model_path='F:\\Git\\Image Processing Midterm Test2\\checkpoints\\CTPN.pth'
    image = cv2.imread(img_path)
    detector = PytorchDetect(model_path)
    text,image,img1 = detector.get_det_boxes(image)
    dis(image)
